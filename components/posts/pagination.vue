...
const  pageNumbersToShow = [Math.max(1, props.currentPage - 1), props.currentPage, Math.min(props.totalPages, props.currentPage + 1)];
...
<template>
    <v-row align="center" justify="center">
        ...
        <span 
            ...
            style="font-weight: bold; font-size: 20px; font-family:'American Typewriter',serif ;padding: 4px 4px; color: #333; "
        >...</span>
