<script setup>
    ...
    function data_count (value) { return Math.ceil(value.length / blogCountLimit);}
            ...
            >
                ...
                >
                    ...
                    <template v-slot="{ data }">
                        <v-container>
                            ...
                            <v-container v-else-if="noResult">
                                <h1>No results matching "<strong>{{ search }}</strong>".</h1>
                            </v-container>
                            <v-container  v-else>
                                <posts-list
                                    :data="data" 
                    ...
                    <template #not-found>
                        ...
                        />
                        <v-container>
                            <h1>There are no posts in this page, maybe try searching on another one.</h1>
                        </v-container>
                    </template>
                </ContentQuery>
            </v-card>
